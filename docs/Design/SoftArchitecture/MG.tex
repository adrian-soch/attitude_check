...
\item [\refstepcounter{mnum} \mthemnum \label{m:iqwomm}:] Initial Quaternion Estimator w/o Mag
Module
\item [\refstepcounter{mnum} \mthemnum \label{m:iqwmm}:] Initial Quaternion Estimator w Mag Module
